...
<div class="search-bar">
  <form class="search-form d-flex align-items-center" method="GET" action="#">
    <input type="search" name="search" placeholder="Search Image" title="Enter search keyword">
    <button type="submit" title="Search"><i class="bi bi-search"></i></button>
  </form>
</div><!-- End Search Bar -->

<a href="{{ url('/image-list') }}" class="btn btn-info">Reset Search</a>
...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    ...
    <div class="hotel">
    <span class="h1" style="float: left;">Gallery</span>
    <span class="h2" style="float: right;">
        <a href="{{url('add-image')}}" class="btn btn-outline-success">Upload a Photo</a>
    </span>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$images->image}}</td>
      <td>  <img src="{{ asset($images->image) }}" style="width: 40px; height: 40px;"></td>
      <td>  <a href="{{ url('delete-image/'.$images->id) }}" class="btn btn-danger btn-sm mx-1">Delete</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
