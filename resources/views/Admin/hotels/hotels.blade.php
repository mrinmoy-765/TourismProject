...
<div class="search-bar">
  <form class="search-form d-flex align-items-center" method="GET" action="#">
    <input type="search" name="search" placeholder="Search Hotel" title="Enter search keyword">
    <button type="submit" title="Search"><i class="bi bi-search"></i></button>
  </form>
</div><!-- End Search Bar -->

<a href="{{ url('/hotel-list') }}" class="btn btn-info">Reset Search</a>
...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    ...
    <div class="hotel">
    <span class="h1" style="float: left;">Hotel List</span>
    <span class="h2" style="float: right;">
        <a href="{{url('add-hotel')}}" class="btn btn-outline-success">Add a new Hotel</a>
    </span>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{url('details/'.$hotel->id)}}" class="btn btn-primary">view details</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
