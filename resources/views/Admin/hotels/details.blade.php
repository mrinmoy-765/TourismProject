...
<table class="table table-sm">
  <thead>
    <tr>
      ...
      <th scope="col">Single bed starting price</th>
      <th scope="col">Double bed starting price</th>
  ...
  <tbody>
    ...
    <th scope="row">{{$hotels->id}}</th> 
      ...
      <td>{{$hotels->singlebed}}</td>
      <td>{{$hotels->doublebed}}</td>
...
<div class="crud">
    <a href="{{ url('edit-hotel/'.$hotels->id) }}" class="btn btn-secondary btn-sm mx-1">Edit</a>
    <a href="{{ url('delete-hotel/'.$hotels->id) }}" class="btn btn-danger btn-sm mx-1">Delete</a>
