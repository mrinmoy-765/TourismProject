...
<div class="search-bar">
  <form class="search-form d-flex align-items-center" method="GET" action="#">
    <input type="search" name="search" placeholder="Search Tour" title="Enter search keyword">
    <button type="submit" title="Search"><i class="bi bi-search"></i></button>
  </form>
</div><!-- End Search Bar -->

<a href="{{ url('/tour-list') }}" class="btn btn-info">Reset Search</a>
...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    ...
    <div class="hotel">
    <span class="h1" style="float: left;">Upcoming Tours</span>
    <span class="h2" style="float: right;">
        <a href="{{url('add-tour')}}" class="btn btn-outline-success">Create a Upcoming Tour</a>
    </span>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$tours->title}}</td>
      <td><a href="{{url('detailstour/'.$tours->id)}}" class="btn btn-primary">view details</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
