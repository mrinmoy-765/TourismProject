  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="{{url('detailsadmin/'.$data->id)}}">
...
<div class="row">
  <div class="col-3 col-s-3 menu">
    <ul>
      ...
      <li><a class="text-white" href="{{URL::asset('./tour-list')}}">Upcoming Tours</a></li>
      <li><a class="text-white" href="">Tour Packges</a></li>
      <li> <a class="text-white" href="{{URL::asset('./contact')}}">Contact Management</a></li>
  ...
  <div class="col-6 col-s-9">
    ...
    <br>
    <img src="{{URL::asset('/Images/lake.jpg')}}" width="750" height="500" alt="failed to load image">
