...
<div class="search-bar">
  <form class="search-form d-flex align-items-center" method="GET" action="#">
    <input type="search" name="search" placeholder="Search Car" title="Enter search keyword" class="black-placeholder">
    <button type="submit" title="Search"><i class="bi bi-search"></i></button>
  </form>
</div><!-- End Search Bar -->


<a href="{{ url('/bus-list') }}" class="btn btn-info">Reset Search</a>
...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    ...
    <div class="hotel">
    <span class="h1" style="float: left;">Bus List</span>
    <span class="h2" style="float: right;">
        <a href="{{url('add-bus')}}" class="btn btn-outline-success">Add a new Bus</a>
    </span>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$buses->operator}}</td>
      <td>{{$buses->coach_no}}</td>
      <td><a href="{{url('detailsbus/'.$buses->id)}}" class="btn btn-primary">view details</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
