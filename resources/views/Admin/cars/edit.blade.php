...
<div class="col-6 col-s-9">
  ...
  <br>
 <form   method="post"   action="{{ url('update-car/'.$car->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
...
<div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control" name="company" value="{{($car->company)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
...
<div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control"name="reg_no"  value="{{($car->reg_no)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
...
<div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control"name="type"  value="{{($car->type)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
...
<div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control"name="model"  value="{{($car->model)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
...
<div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control"name="year"  value="{{($car->year)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
 ...
 <div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control"name="seat" value="{{($car->seat)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
 ...
 <div class="input-group flex-nowrap">
  ...
  <input type="text" class="form-control"name="bodyrent"  value="{{($car->bodyrent)}}" placeholder="" aria-label="Username" aria-describedby="addon-wrapping">
...
<div class="box">
  ...
  <div class="row">
    ...
    <div class="col-4 col-s-12">
        <br>
        <img src="{{ asset($car->image) }}" style="width: 400px; height: 250px;">
    </div>
</div> 
