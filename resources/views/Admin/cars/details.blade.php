...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{ asset($car->image) }}" class="d-block w-100" alt="...">
    </div>
...
<div class="crud">
    <a href="{{ url('edit-car/'.$car->id) }}" class="btn btn-secondary btn-sm mx-1">Edit</a>
    <a href="{{ url('delete-car/'.$car->id) }}" class="btn btn-danger btn-sm mx-1">Delete</a>
